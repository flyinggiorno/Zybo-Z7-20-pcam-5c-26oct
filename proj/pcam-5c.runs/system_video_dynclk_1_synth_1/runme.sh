...
HD_PWD='C:/Users/admin/repo/Zybo-Z7-20-pcam-5c-26oct/proj/pcam-5c.runs/system_video_dynclk_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_video_dynclk_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_video_dynclk_1.tcl
